	...
	<%
				...
				String cn7 = request.getParameter("cn7");
					try{
						...
						String sql = String.format("update tbl_member_202205 set custname = '%s', phone= '%s', address = '%s', joindate = '%s', grade = '%s', city = '%s' where custno = '%s'",cn2,cn3,cn4,cn5,cn6,cn7,cn);
